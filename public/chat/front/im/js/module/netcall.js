...
fn.onCallingRejected = function (obj) {
    ...
    this.log("对方拒绝音视频通话");
    var lang = util.readCookie("lang");
    if(lang == null || lang == undefined){
        lang = "zh_CN";
    }
    dataArray = getLanguageArray(lang);
    this.showTip(dataArray["alreadyReject"], 2000, this.hideAllNetcallUI.bind(this));
    this.clearCallTimer();
    this.sendLocalMessage(dataArray["alreadyReject"]);
};
