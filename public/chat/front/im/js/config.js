(function() {
  // 配置
  var envir = 'online';
  var hostDomain = "http://" + window.location.host;
  var configMap = {
    dev: {
    ...
    online: {
      ...
      url: hostDomain,
      chatroomList: hostDomain+'/front/homeList',
      chatroomAddr: hostDomain+'/front/chatroomAddr'
    }
  };
        ...
        if (xmlHttp.readyState === 4) {
          if (xmlHttp.status === 200) {
            ...
            if (typeof data === 'object') {
              ...
              window.CONFIG.chatroomList = data['chatroomList']
              window.CONFIG.chatroomAddr = data['chatroomAddr']
            } else {
